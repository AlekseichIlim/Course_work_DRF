    ...
    def __call__(self, value):
        ...
        if val.get('related_habit'):
            ...
            if rel_hab.pleasant is False:
                raise ValidationError(f'Связанной привычкой может быть только приятная привычка!')
        ...
        elif val.get('pleasant') is True and (val.get('prize') or val.get('related_habit')):
